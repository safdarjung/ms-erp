...
export default async function NewQuotationPage() {
  ...
  const defaultTerms = Array.isArray(lh?.defaultTerms) ? lh.defaultTerms.join('\n') : '';
  ...
  return (
    <div className="max-w-4xl">
      ...
      <QuotationForm customers={customers} supplierStateCode={lh?.stateCode ?? '06'} defaultTerms={defaultTerms} />
    </div>
  );
}
